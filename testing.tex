...
<li>Move points A and B such that they are 4 units apart.</li>
<li>Move point C to create a right angle at <u>/</u>B and where C is 3 units from B</li>
<p>Question:What is the measure of segment AC?</p>}
$\answer{5}$
\begin{hint}
