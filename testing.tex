...
\end{problem}
\end{document}
\HCode{<a title="View with the Desmos Graphing Calculator" href="https://www.desmos.com/calculator/mrgngo8qrm">  <img src="https://s3.amazonaws.com/calc_thumbs/production/mrgngo8qrm.png" width="200px" height="200px"     style="border:1px solid #ccc; border-radius:5px"  /></a>}
